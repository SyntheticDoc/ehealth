 ...
 */
package ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely;
...
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.detectors.QrsDetector;
...
public class EcgSignal implements List<Double> {
	 ...
	 * 
	 * @param signal Original signal which should be cloned.
	 */
	...
	/**
	 * 
	 * @return the exact (millisecond precision) time and date at which the first
	 *         sample of this signal was recorded.
	 */
	public Date getDate() {
	...
	/**
	 * Applies the given DigitalFilter to this ECG signal and returns a new
	 * EcgSignal with the filtered signal.
	 * 
	 * @param filter
	 * @return
	 */
	 ...
	 * 
	 * @param firstSample the first sample which should be included in the resulting
	 *                    array.
	 * @param lastSample  the last sample which should be included in the resulting
	 *                    array.
	 * @return an array of double values that represent the part [firstSample,
	 *         lastSample] of the original signal.
	 */
