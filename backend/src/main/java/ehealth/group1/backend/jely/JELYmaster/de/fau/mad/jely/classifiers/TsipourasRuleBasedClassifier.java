 ...
 */
package ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.classifiers;

import java.util.ArrayList;
import java.util.List;

import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.BeatClass;
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.Heartbeat;
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.QrsClass;
...
public class TsipourasRuleBasedClassifier implements Classifier {
    ...
    public List<TsipourasClass> classifyToTsipourasClass(List<QrsComplex> qrsComplexes) {
        ...
        ArrayList<TsipourasClass> qrsClasses = new ArrayList<TsipourasClass>();
        for (int i = 0; i < qrsComplexes.size(); i++) {
            qrsClasses.add(tsipourasClasses.get(i));
        }
