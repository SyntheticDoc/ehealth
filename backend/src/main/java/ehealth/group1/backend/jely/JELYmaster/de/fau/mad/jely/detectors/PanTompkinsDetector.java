...
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.filter.LmeFilter.MinDetectionFilter;
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.filter.LmeFilter.PeakDetectionFilter;
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.filter.LmeFilter.StatFilter;
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.filter.LmeFilter.WndIntFilter;
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.filter.MeanFilter;
import ehealth.group1.backend.jely.JELYmaster.de.fau.mad.jely.util.DescriptiveStatistics;
import ehealth.group1.backend.jely.ShiftListmaster.de.fau.shiftlist.ShiftListDouble;
import ehealth.group1.backend.jely.ShiftListmaster.de.fau.shiftlist.ShiftListObject;
