 ...
 *  @author Kevin Wayne
 */
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, MouseWheelListener, KeyListener {

    public static int mouseWheelRot;
    public static int mouseButtonClicked;
    public static int mouseButtonMoved;
    public static boolean isMouseWheelRotated;
    ...
    private static void init() {
        ...
        frame.setTitle("HeartGuard ECG data visualizer");
    ...
    private static JMenuBar createMenuBar() {
        ...
        // Java 10+: replace getMenuShortcutKeyMask() with getMenuShortcutKeyMaskEx() -- done! (Michael)
...
*/
    ...
    ***************************************************************************/
    ...
    public static int getMouseButtonClicked() {
        return mouseButtonClicked;
    }

    public static int getMouseButtonMoved() {
        return mouseButtonMoved;
    }

    public static boolean isMouseWheelRotated() {
        boolean temp = isMouseWheelRotated;
        isMouseWheelRotated = false;
        return temp;
    }

    public static int getMouseWheelRotation() {
        int temp = mouseWheelRot;
        mouseWheelRot = 0;
        return temp;
    }
